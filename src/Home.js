...
export class Home extends Component{
    ...
    createClick(){
        fetch(variables.API_URL+'Empleado',{
            ...
            body:JSON.stringify({
                ...
                area_empleado:this.state.area_empleado
            })
        })
        .then(res=>res.json())
        .then((result)=>{
    ...
    render(){
        ...
        var {isLoaded, items, modalTitle, id_empleado, nombre_empleado, puesto_empleado, area_empleado}
        = this.state;
        if(!isLoaded)
        {
       ...
       <div className="input-group mb-3">
        ...
        <input type="text" className="form-control" value={area_empleado} onChange={this.changeEmpArea}/>
       </div>
       {id_empleado===0?
        <button type="button"
